...
//    * @return {*}
//    */
//   [createUserShellCompositor] (store, next, action) {
...
//    * @return {*}
//    */
//   [createUserShellScene] (store, next, action) {
...
//       store.dispatch(createUserShellScene({ name: 'remote', type: 'remote', id: sceneId }))
//       next(action)
